document.addEventListener('DOMContentLoaded',  function () {
    ...
    function validatePhone(phone) {
        ...
        const afterCodePos = digits.startsWith('8') ? 4 : 5;
    ...
    awardBtn.addEventListener('click', function () {
        ...
        bonusBlock.textContent = `Премия выдается следующим сотрудникам: ${selectedSurnames.join(', ')}.`;
